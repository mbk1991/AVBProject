    ...
    <div id="contents">
        <div id="wrap">
            <form action="/member/nickname/register.do" method="post">
                <input type="text" id="id"  name="memberId" placeholder="아이디는 영소문자,숫자 4~16자입니다." onblur="idCheck(this);" required style="width:300px;">
                <div id="idCheck"></div>
                <input type="password" id="pwd" name="memberPwd"   placeholder="비밀번호는 영문,숫자 4~12자입니다." onblur="pwdCheck(this);" required style="width:300px;"><br>
